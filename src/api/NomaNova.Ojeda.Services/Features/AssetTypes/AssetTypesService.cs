...
using NomaNova.Ojeda.Services.Features.AssetTypes.Validators;
using NomaNova.Ojeda.Utils.Extensions;

namespace NomaNova.Ojeda.Services.Features.AssetTypes;

public class AssetTypesService : BaseEntityService<AssetType>, IAssetTypesService
{
